 ...
 */
class MashhadSmsProvider extends AbstractProvider
{
    /**
     * @var string
     */
    const SEND_SMS_URL = 'http://37.130.202.188/services.jspd';
    ...
    public function send($recipient, $body, $originator = '')
    {
        ...
        $params = $this->getParameters(array(
            'to'      => json_encode(array($this->localNumberToInternational($recipient, $this->international_prefix))),
            'message'      => $body,
            'from' => $originator,
            'op'  => 'send',
        ));
